...
description: Executes implementation work according to design specifications within the action-lite methodology. Use when an action has completed design phase and needs to be built.
