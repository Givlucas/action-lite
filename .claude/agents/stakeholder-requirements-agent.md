...
description: Gathers requirements through structured interviews and creates initial action files in discovery phase. Use when starting new actions that need comprehensive requirements gathering.
