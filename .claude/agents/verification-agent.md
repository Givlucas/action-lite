...
description: Tests implementations against specifications to ensure the mandatory testing phase is never skipped in action-lite. Use when implementation is complete and needs verification before progressing.
