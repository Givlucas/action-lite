...
This project differs from my other respositories in the scope of LLM usage. While I myself am a LLM skeptic I find it necessary to keep up with and evaluate the capabilites and scope these tools can handle. Unlike my other repo's this project is to be written paritially or fully by LLMs. In general I avoid using _any_ LLM generated code in personal projects unless for extremely tedious or simple tasks, as I believe it is best for my professional development. While the code my be AI written the action work flow is entirely of my own design and is primarily designed for human use. [Please see my statement on LLM use for my opinions](https://github.com/Givlucas/LLM-instructions/blob/main/Statement%20on%20LLM%20use.md)
